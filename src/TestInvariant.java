...
public class TestInvariant extends TestCase {
    ...
    public void testA0() {
    	...
    	lc = spy.newInstance(d0, 0);
    	assertWellFormed(true, lc);
    }
    
    public void testA1() {
    	lc = spy.newInstance(null, 0);
    	assertWellFormed(false, lc);
    }
    
    public void testA2() {
    	lc = spy.newInstance(d1, 0);
    	assertWellFormed(false, lc);
    }
    
    public void testA3() {
    	spy.linkForward(d2, d2);
    	lc = spy.newInstance(d2, 0);
    	assertWellFormed(false, lc);
    }
